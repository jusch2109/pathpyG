...
layout_torch = SGD_stress_torch(highschool_graph, iterations=100, delta=DELTA, learning_rate=0.001)
...
layout_torch = SGD_stress_torch(hospital_graph, iterations=100, delta=DELTA, learning_rate=0.001)
...
layout_torch = SGD_stress_torch(office_graph, iterations=100, delta=DELTA, learning_rate=0.001)
...
layout_torch = SGD_stress_torch(flights, iterations=100, delta=DELTA, learning_rate=0.001)
...
tube = pp.PathData.from_ngram("rc/pathpyG/visualisations/Project_JS/graphs/Tube/tube.ngram")
...
layout_torch = SGD_stress_torch(tube, iterations=100, delta=DELTA, learning_rate=0.001)
...
layout_torch = SGD_stress_torch(wiki, iterations=100, delta=DELTA, learning_rate=0.001)
